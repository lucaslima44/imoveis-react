    ...
    <section id="sobre" className="pt-6 w-[90%] mx-auto">
      <div className="flex flex-col items-center">
        ...
        <p className="text-sm pt-8">
          Fundada em 2021, a Imobiliária tem como missão ajudar todos a
          encontrarem seu próprio lar. <br /> Oferecemos uma variedade de
        ...
        <div
          id="localizacao"
          className="my-10 w-full h-full xl:w-[50%] xl:h-[300px]"
        >
          <iframe
            className="w-full h-full"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3654.1624220294298!2d-46.79073124997008!3d-23.670148871427152!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce5a2b2ed7fcbd%3A0x5a7fdebd2a0b8f0!2sAv.%20Paulista%2C%20S%C3%A3o%20Paulo%20-%20SP!5e0!3m2!1spt-BR!2sbr!4v1685124001509!5m2!1spt-BR!2sbr"
          ></iframe>
        </div>
      </div>
    </section>
